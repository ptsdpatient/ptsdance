        ...
        while gameOver:
            ...
            for event in pygame.event.get():
               ...
               if event.type==pygame.MOUSEBUTTONDOWN:
                    if btn_1_rect.collidepoint(event.pos):   
                        sound=pygame.mixer.Sound("src/sound/start.mp3")
                        sound.set_volume(0.8)
                        sound.play()
                        gameOver=False         
                        
                    if btn_2_rect.collidepoint(event.pos):
                        sound=pygame.mixer.Sound("src/sound/start.mp3")
                        sound.set_volume(0.8)
                        sound.play()
                        pygame.quit()
...
def draw_disco_ball():
    ...
    # print(dance_floor_rect.bottomleft,dance_floor_rect.bottomright)
...
class spawnCollector(pygame.sprite.Sprite):
    ...
    def update(self):
         ...
         mouse_x=mouse[0]
         if (key[pygame.K_LEFT] or key[pygame.K_a] or (mouse_key and mouse_x>0 and mouse_x<100)) and self.rect.x==10:
             sound=pygame.mixer.Sound("src/sound/btn1.mp3")
             sound.set_volume(0.3)
             sound.play()
             self.rect.x=5    
         if (key[pygame.K_DOWN] or key[pygame.K_s] or (mouse_key and mouse_x>100 and mouse_x<180)) and self.rect.x==100 and self.rect.y==40:
             sound=pygame.mixer.Sound("src/sound/btn1.mp3")
             sound.set_volume(0.3)
             sound.play()
             self.rect.y=45
         if (key[pygame.K_RIGHT] or key[pygame.K_d] or (mouse_key and mouse_x>190 and mouse_x<270)) and self.rect.x==190:
             sound=pygame.mixer.Sound("src/sound/btn1.mp3")
             sound.set_volume(0.3)
             sound.play()
             self.rect.x=195   
         if (key[pygame.K_UP] or key[pygame.K_w] or (mouse_key and mouse_x>280 and mouse_x<360)) and self.rect.x==280 and self.rect.y==40:
             sound=pygame.mixer.Sound("src/sound/btn1.mp3")
             sound.set_volume(0.3)
             sound.play()
             self.rect.y=35

         if self.rect.x==5 and not (key[pygame.K_LEFT] or key[pygame.K_a] or (mouse_key and mouse_x>0 and mouse_x<100)):
             self.rect.x=10
         if self.rect.x==100 and not (key[pygame.K_DOWN] or key[pygame.K_s] or (mouse_key and mouse_x>100 and mouse_x<180)):
             self.rect.y=40
         if self.rect.x==195 and not (key[pygame.K_RIGHT] or key[pygame.K_d] or (mouse_key and mouse_x>190 and mouse_x<270)):
             self.rect.x=190
         if self.rect.x==280 and not (key[pygame.K_UP] or key[pygame.K_w] or (mouse_key and mouse_x>280 and mouse_x<360)):
             self.rect.y=40
...
class spawnArrow(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.y<50:
             ...
             mouse_x=mouse[0]
             key=pygame.key.get_pressed()
             if (key[pygame.K_LEFT] or key[pygame.K_a] or (mouse_key and mouse_x>0 and mouse_x<100)) and self.rect.x==15:
                gameScore+=1
                right_arrows+=1
                ...
                self.kill()
             if (key[pygame.K_DOWN] or key[pygame.K_s] or (mouse_key and mouse_x>100 and mouse_x<180)) and self.rect.x==105:
                gameScore+=1
                right_arrows+=1
                ...
                self.kill()
             if (key[pygame.K_RIGHT] or key[pygame.K_d] or (mouse_key and mouse_x>190 and mouse_x<270)) and self.rect.x==195:
                gameScore+=1
                right_arrows+=1
                ...
                self.kill()
             if (key[pygame.K_UP] or key[pygame.K_w] or (mouse_key and mouse_x>280 and mouse_x<360)) and self.rect.x==285:
                gameScore+=1
                right_arrows+=1
...
while not gameOver:
    ...
    for event in pygame.event.get():
        ...
        mouse_x=mouse[0]
        mouse_y=mouse[1]
        if mouse_key and (mouse_y>200) and (mouse_x>425 and mouse_x<775):
            if music_list_index<len(file_list):    
                pygame.mixer.music.stop()
                pygame.mixer.music.load("src/music/"+str(file_list[music_list_index]))
                pygame.mixer.music.set_volume(0.5)
